...
export function CampaignsPage() {
  ...
  const ondImport = <Card className="mb-5 border-primary"><h2 className="font-semibold">October–December planning</h2><p className="my-2">Import one consolidated OND workbook, review exceptions, then print store execution packs.</p><Link className="inline-block rounded bg-primary px-4 py-2 font-semibold text-primary-foreground" to="/imports/flyer">Import consolidated OND workbook</Link></Card>;
