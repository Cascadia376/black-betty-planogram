        ...
        <>
          ...
          <div className="mb-4 flex flex-wrap items-center justify-between gap-3 rounded-md border border-border bg-surface p-3">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              {layoutManagementMode && <button type="button" disabled={saving} onClick={duplicate} className="inline-flex min-h-9 items-center gap-2 rounded-md border border-border bg-surface px-3 text-sm font-semibold hover:bg-subtle disabled:opacity-50"><Copy className="h-4 w-4" />Duplicate as draft</button>}
              {layoutManagementMode && layout.status !== "current" && <button type="button" disabled={saving} onClick={publish} className="inline-flex min-h-9 items-center rounded-md bg-primary px-3 text-sm font-semibold text-primary-foreground disabled:opacity-50">Make current</button>}
            </div>
          </div>
