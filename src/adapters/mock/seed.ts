...
export const IDS = {
  ...
  coastalLagerProduct: "d3000000-0000-4000-8000-000000000001",
  islandIpaProduct: "d3000000-0000-4000-8000-000000000002",
  pacificPilsnerProduct: "d3000000-0000-4000-8000-000000000003",
  harvestRedProduct: "d3000000-0000-4000-8000-000000000004",
  citrusCoolerProduct: "d3000000-0000-4000-8000-000000000005",
  pendingCampaignProduct: "d3000000-0000-4000-8000-000000000006",
  inactiveCampaignProduct: "d3000000-0000-4000-8000-000000000007",
...
export const seedSnapshot: PlatformSnapshot = {
  ...
  products: [
    ...
    { id: IDS.ondHolidayProduct, sku: "MOCK-OND-2001", name: "Mock Holiday Cream Liqueur", category: "Spirits", packageSize: "750 mL", casePack: 6, masterStatus: "verified", active: true, synthetic: true },
    { id: IDS.ondExitProduct, sku: "MOCK-OND-EXIT-01", name: "Mock Seasonal Gift Set", category: "Gifts", packageSize: "Gift set", casePack: 6, masterStatus: "verified", active: true, synthetic: true },
    { id: IDS.ondCiderProduct, sku: "MOCK-OND-3001", name: "Mock Winter Cider Pack", category: "Cider", packageSize: "6 x 355 mL", casePack: 6, masterStatus: "verified", active: true, synthetic: true },
    { id: IDS.coastalLagerProduct, sku: "MOCK-1001", name: "Coastal Lager 12 Pack", category: "Beer", brand: "Mock Coast Brewing", packageSize: "12 x 355 mL", casePack: 2, masterStatus: "verified", active: true, synthetic: true },
    { id: IDS.islandIpaProduct, sku: "MOCK-1002", name: "Island IPA 6 Pack", category: "Beer", brand: "Mock Island Brewing", packageSize: "6 x 355 mL", casePack: 4, masterStatus: "verified", active: true, synthetic: true },
    { id: IDS.pacificPilsnerProduct, sku: "MOCK-1003", name: "Pacific Pilsner 8 Pack", category: "Beer", brand: "Mock Pacific Brewing", packageSize: "8 x 355 mL", casePack: 3, masterStatus: "verified", active: true, synthetic: true },
    { id: IDS.harvestRedProduct, sku: "MOCK-2001", name: "Harvest Red Blend", category: "Wine", brand: "Mock Valley Cellars", packageSize: "750 mL", casePack: 12, masterStatus: "verified", active: true, synthetic: true },
    { id: IDS.citrusCoolerProduct, sku: "MOCK-3001", name: "Citrus Cooler Variety", category: "Ready to drink", packageSize: "12 x 355 mL", casePack: 2, masterStatus: "verified", active: true, synthetic: true },
    { id: IDS.pendingCampaignProduct, sku: "MOCK-NEW-4001", name: "Mock Winter Aperitif", category: "Spirits", brand: "Mock New Supplier", packageSize: "750 mL", casePack: 6, masterStatus: "pending", active: true, synthetic: true, notes: "Synthetic temporary product awaiting authoritative Product Master reconciliation." },
    { id: IDS.inactiveCampaignProduct, sku: "MOCK-OLD-9001", name: "Mock Retired Seasonal Pack", category: "Gifts", packageSize: "Gift pack", casePack: 6, masterStatus: "verified", active: false, synthetic: true },
  ],
  zones: [
  ...
  campaigns: [
    ...
    },
    {
      ...
      products: [
        { id: "51000000-0000-4000-8000-000000000001", campaignId: IDS.beerCampaign, productId: IDS.coastalLagerProduct, role: "Feature", required: true },
        { id: "51000000-0000-4000-8000-000000000002", campaignId: IDS.beerCampaign, productId: IDS.islandIpaProduct, role: "Core", required: true },
        { id: "51000000-0000-4000-8000-000000000003", campaignId: IDS.beerCampaign, productId: IDS.pacificPilsnerProduct, role: "Supporting", required: false },
      ],
    ...
    },
    {
      ...
      owner: "Buying Team", supplier: "Multiple suppliers", status: "scheduled",
      products: [{ id: "52000000-0000-4000-8000-000000000001", campaignId: IDS.seasonalCampaign, productId: IDS.harvestRedProduct, role: "Feature", required: true }],
